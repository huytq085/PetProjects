...
public class Weather extends AppCompatActivity {
    ...
    public void findWeather(View view){
        ...
        try {
            String encodedCityName = URLEncoder.encode(etCity.getText().toString(), "UTF8");
            DownloadTask task = new DownloadTask();
            task.execute("http://api.openweathermap.org/data/2.5/weather?q=" + encodedCityName + "&appid=9ca27d032c7e6f909992036120b71771");
